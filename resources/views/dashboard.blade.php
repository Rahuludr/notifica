...
<body class="bg-gray-100 font-sans antialiased">
                ...
                <div class="mt-10 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach(\App\Models\Report::latest()->take(10)->get() as $todaysReport )
                            <tr class="hover:bg-gray-50 transition">
        
         
                                <td class="px-6 py-4">{{ $todaysReport->Mines_Site }}</td>
                                <td class="px-6 py-4 text-gray-500">{{ number_format((float)$todaysReport->OP_achv * 100, 2)}}%</td>
                                <td class="px-6 py-4 text-gray-500">{{ number_format((float)$todaysReport->MD_achv * 100, 2)}}%</td>
                                <td class="px-6 py-4 text-gray-500 text-right">{{ $todaysReport->created_at }}</td>
 ...
 <script>
        ...
        const rawData = @json($monthlyMineAverages);
