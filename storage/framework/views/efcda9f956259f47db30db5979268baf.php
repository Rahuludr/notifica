...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('reports.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/desktopnotification/resources/views/admin/import.blade.php ENDPATH**/ ?>